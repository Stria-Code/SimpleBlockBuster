    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                {
                    RestoreCachedVertexAttributes(m_lastIndex, GetM_cachedMeshInfoVertexData());
                    m_lastIndex = -1;
                }
        ...
        private TMP_MeshInfo[] GetM_cachedMeshInfoVertexData()
        {
            return m_cachedMeshInfoVertexData;
        }

        void RestoreCachedVertexAttributes(int index, TMP_MeshInfo[] m_cachedMeshInfoVertexData)
        {
